...
if (typeof WXEnvironment$1 !== 'undefined'
  && (WXEnvironment$1.platform === 'iOS' || WXEnvironment$1.platform === 'android')
  && !WXEnvironment$1.__enable_native_promise__) {
  ...
  if (global.WXEnvironment && global.WXEnvironment.platform !== 'Web') {
    global.console = {
      debug: function () {
        ...
        if (checkLevel('debug')) {
          if (__global && __global.nativeLog) {
            __global.nativeLog.apply(__global, format(args).concat( ['__DEBUG'] ));
          } else {
      ...
      log: function () {
        ...
        if (checkLevel('log')) {
          if (__global && __global.nativeLog) {
            __global.nativeLog.apply(__global, format(args).concat( ['__LOG'] ));
          } else {
      ...
      info: function () {
        ...
        if (checkLevel('info')) {
          if (__global && __global.nativeLog) {
            __global.nativeLog.apply(__global, format(args).concat( ['__INFO'] ));
          } else {
      ...
      warn: function () {
        ...
        if (checkLevel('warn')) {
          if (__global && __global.nativeLog) {
            __global.nativeLog.apply(__global, format(args).concat( ['__WARN'] ));
          } else {
      ...
      error: function () {
        ...
        if (checkLevel('error')) {
          if (__global && __global.nativeLog) {
            __global.nativeLog.apply(__global, format(args).concat( ['__ERROR'] ));
          } else {
...
//# sourceMappingURL=wxflutter-weex-js-framework.js.map
